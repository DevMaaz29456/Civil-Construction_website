...
import backgroundimg from "../assets/assets/homeimg.webp";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          we will build dream houses
        </motion.h1>
        <div className="w-[120px] h-[6px] bg-yellow-500"></div>
        <p className="text-white text-[20px]">
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Provident,
          facere nam doloribus eligendi autem omnis delectus odio deleniti
          dolore totam fugiat ea molestias fuga. Vero.
        </p>
        <motion.div
          initial="hidden"
